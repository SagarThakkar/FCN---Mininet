...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        quaggaHosts.append(QuaggaHost(name='H1', ip='172.0.1.1/24',
                                      loIP='10.0.1.1/24'))
        quaggaHosts.append(QuaggaHost(name='H2', ip='172.0.4.1/24',
                                      loIP='10.0.2.1/24'))
        quaggaHosts.append(QuaggaHost(name='R1', ip='172.0.1.2/24',
                                      loIP='10.0.3.1/24'))
        quaggaHosts.append(QuaggaHost(name='R2', ip='172.0.2.2/24',
                                      loIP='10.0.4.1/24'))
        quaggaHosts.append(QuaggaHost(name='R3', ip='172.0.5.2/24',
                                      loIP='10.0.5.1/24'))
        quaggaHosts.append(QuaggaHost(name='R4', ip='172.0.4.2/30',
                                      loIP='10.0.6.1'))
	...
	self.addLink(qh[0],qh[2])
	self.addLink(qh[2],qh[3])
	self.addLink(qh[2],qh[4])
	self.addLink(qh[5],qh[1])
	self.addLink(qh[3],qh[5])
	self.addLink(qh[4],qh[5])
#	self.addLink(qh[5],qh[1])
